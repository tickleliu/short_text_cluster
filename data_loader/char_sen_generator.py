...
class CharSenGenerator(DataGenerator):
    ...
    def __init__(self, config):
        ...
        if os.path.exists("../temp/features.pkl"):
            ...
            print("calc lle")
            Y["lle"] = binarize(lle(normed_tfidf, config.embedding_dim))
            print("calc tsne")
            Y["tsne"] = binarize(tsne(normed_tfidf, config.embedding_dim))
            print("calc isomap")
            Y["isomap"] = binarize(isomap(normed_tfidf, config.embedding_dim))
            print("calc mds")
            Y["mds"] = binarize(mds(normed_tfidf, config.embedding_dim))
            print("calc le")
            Y["le"] = binarize(le(normed_tfidf, config.embedding_dim))
